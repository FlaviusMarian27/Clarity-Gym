  ...
  <div>
    ...
    <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-6">
            ...
            <RouterLink
            to="/login"
            class="px-10 py-4 bg-primary hover:bg-secondary text-white text-xl font-semibold rounded-2xl transition-colors duration-200"
            >
            Alătură-te nouă
            </RouterLink>
        </div>
    ...
    <!-- RECENZII -->
    <section id="recenzii" class="py-24 bg-card">
        <div class="max-w-6xl mx-auto px-8">
            ...
            <!-- Review 1 -->
            <div class="bg-bg rounded-2xl p-6 shadow-sm">
    ...
    <!-- SUPORT -->
    <section id="suport" class="py-24 bg-card">
        <div class="max-w-6xl mx-auto px-8">
            ...
            <div class="flex flex-col gap-4">
                ...
                rows="5"
                class="border border-primary rounded-xl px-4 py-3 text-text bg-bg focus:outline-none focus:ring-2 focus:ring-secondary resize-none"
                ></textarea>

                <button class="bg-primary hover:bg-secondary text-white font-semibold py-3 rounded-xl transition-colors duration-200">
                Trimite
                </button>
    ...
    <section id="contact" class="py-24 bg-bg">
        <div class="max-w-6xl mx-auto px-8">
            ...
            <!-- Facebook -->
            <a href="https://facebook.com" target="_blank" class="flex flex-col items-center gap-3 p-6 bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 w-36 group">
            ...
            <!-- Instagram -->
            <a href="https://instagram.com" target="_blank" class="flex flex-col items-center gap-3 p-6 bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 w-36 group">
            ...
            <!-- TikTok -->
            <a href="https://tiktok.com" target="_blank" class="flex flex-col items-center gap-3 p-6 bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 w-36 group">
                <svg class="w-10 h-10 text-text" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- WhatsApp -->
            <a href="https://wa.me/40700000000" target="_blank" class="flex flex-col items-center gap-3 p-6 bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 w-36 group">
            ...
            <!-- Email -->
            <a href="mailto:contact@claritygym.ro" class="flex flex-col items-center gap-3 p-6 bg-card rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 w-36 group">
